...
## Project Structure
    ...
    ├── testapiautodatamode_53506  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_53506`
...
2. Clone this repo and `cd testapiautodatamode_53506`
